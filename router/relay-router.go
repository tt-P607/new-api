...
func SetRelayRouter(router *gin.Engine) {
	...
	playgroundRouter.Use(middleware.ChannelRateLimit())
	{
	...
	relayV1Router.Use(middleware.ModelRequestRateLimit())
	{
		...
		wsRouter.Use(middleware.ChannelRateLimit())
	...
	}
	{
		...
		httpRouter.Use(middleware.ChannelRateLimit())
	...
	relaySunoRouter.Use(middleware.ChannelRateLimit())
	{
	...
	relayGeminiRouter.Use(middleware.ChannelRateLimit())
	{
...
func registerMjRouterGroup(relayMjRouter *gin.RouterGroup) {
	...
	relayMjRouter.Use(middleware.ChannelRateLimit())
	{
